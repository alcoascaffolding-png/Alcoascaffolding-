    ...
    <div className="min-h-screen bg-surface-light dark:bg-surface-dark transition-theme">
      <section className="bg-gradient-to-br from-brand-primary-50 to-brand-accent-50 dark:from-brand-primary-950 dark:to-brand-accent-950 py-12 sm:py-16 lg:py-24 transition-theme">
        <div className="container-custom text-center max-w-3xl sm:max-w-4xl mx-auto px-2">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-text-primary dark:text-text-primary-dark mb-4 sm:mb-6">A Type Ladder</h1>
          <p className="text-base sm:text-lg lg:text-xl text-text-secondary dark:text-text-secondary-dark">Versatile A-type ladders with secure locks, anti-slip feet, and portable design.</p>
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link to="/contact-us?service=a-type-ladder" className="btn-primary">Get Quote</Link>
        ...
        <div className="container-custom grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 card">
            ...
            <ul className="list-disc pl-6 space-y-2 text-text-secondary dark:text-text-secondary-dark">
              <li>Durable hinge and secure locking mechanisms</li>
              <li>Anti-slip feet and step surfaces</li>
          ...
          <div className="card">
            ...
            <div className="space-y-3 text-sm text-text-secondary dark:text-text-secondary-dark">
              ...
              <div className="flex items-center justify-between gap-4"><span>Heights</span><span className="text-right">Multiple</span></div>
              <div className="flex items-center justify-between gap-4"><span>Safety</span><span className="text-right">Anti-slip feet</span></div>
            </div>
            <Link to="/contact-us?service=a-type-ladder" className="btn-primary mt-6 w-full text-center">Request Quote</Link>
          </div>
        </div>
      </section>
    </div>
