...
const SuspendedPlatforms = () => {
  const features = [
    'Motorized lifting system with remote control',
    'Safety harness integration points',
    'Weather protection canopy included',
    'Emergency descent system',
    'Dual safety locks for maximum security',
  ...
  const specifications = {
    ...
    'Platform Length': '4m, 6m, 8m options available',
    'Load Capacity': '500kg working load',
    'Lifting Speed': '6-8 meters per minute',
    'Safety Features': 'Dual safety locks, emergency stop',
    'Power Source': 'Electric motor with backup system',
    'Control System': 'Remote control with safety features',
    'Standards Compliance': 'AS/NZS 1576.3, BS EN 1808'
  };
  ...
  const advantages = [
    {
      ...
      description: 'Smooth, controlled movement with remote operation'
    },
    {
      icon: FiShield,
      title: 'Maximum Safety',
      description: 'Multiple safety systems and professional training'
    },
    {
      icon: FiSettings,
      title: 'Professional Setup',
      description: 'Expert installation and maintenance service'
    },
    {
      icon: FiAlertTriangle,
      title: 'Emergency Ready',
      description: 'Built-in emergency systems and backup power'
    }
  ];

  const pricing = [
    { period: 'Daily', price: '$185', description: 'Perfect for short-term projects' },
    { period: 'Weekly', price: '$1,100', description: 'Best value for medium projects', popular: true },
    { period: 'Monthly', price: '$3,500', description: 'Ideal for long-term operations' }
  ];
        ...
        <div className="container-custom">
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <FiLayers className="w-12 h-12 text-brand-primary-600 mr-4" />
            ...
            <p className="text-base sm:text-lg lg:text-xl text-text-secondary dark:text-text-secondary-dark mb-6 sm:mb-8">
              Professional suspended access solutions for high-rise building maintenance, 
              facade work, and specialized construction projects requiring vertical access.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact-us?product=suspended-platforms" className="btn-primary">
                Get Quote
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-text-primary dark:text-text-primary-dark mb-4 sm:mb-6">
                Professional Vertical Access Solutions
              </h2>
              <p className="text-sm sm:text-lg text-text-secondary dark:text-text-secondary-dark mb-4 sm:mb-6">
                Our suspended platforms provide safe, efficient access to high-rise buildings 
                and structures. Engineered with advanced safety systems and motorized controls 
                for professional construction and maintenance work.
              </p>
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                <div className="flex items-center space-x-3">
                  <FiZap className="w-6 h-6 text-blue-500" />
                  <span className="text-text-secondary dark:text-text-secondary-dark">Motorized Control</span>
                </div>
                <div className="flex items-center space-x-3">
                  <FiShield className="w-6 h-6 text-green-500" />
                  <span className="text-text-secondary dark:text-text-secondary-dark">Maximum Safety</span>
                </div>
                <div className="flex items-center space-x-3">
                  <FiSettings className="w-6 h-6 text-purple-500" />
                  <span className="text-text-secondary dark:text-text-secondary-dark">Professional Setup</span>
                </div>
                <div className="flex items-center space-x-3">
                  <FiAlertTriangle className="w-6 h-6 text-red-500" />
                  <span className="text-text-secondary dark:text-text-secondary-dark">Emergency Ready</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-video bg-gradient-to-br from-brand-primary-100 to-brand-accent-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl flex items-center justify-center">
                <FiLayers className="w-24 h-24 sm:w-32 sm:h-32 text-brand-primary-600 dark:text-gray-300" />
              </div>
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg">
                <div className="text-center">
                  <div className="text-2xl font-bold text-brand-primary-600">500kg</div>
                  <div className="text-sm text-text-secondary dark:text-text-secondary-dark">Working Load</div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-text-primary dark:text-text-primary-dark mb-4">
              Why Choose Suspended Platforms?
            </h2>
            <p className="text-lg text-text-secondary dark:text-text-secondary-dark max-w-3xl mx-auto">
              Experience the ultimate in vertical access technology with unmatched safety and efficiency
            </p>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-text-secondary dark:text-text-secondary-dark max-w-3xl mx-auto">
              State-of-the-art technology meets uncompromising safety standards
            </p>
          </motion.div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-text-secondary dark:text-text-secondary-dark max-w-3xl mx-auto">
              Multiple layers of safety protection ensure secure operation in all conditions
            </p>
          </motion.div>
      ...
      <section className="section-padding bg-surface-muted dark:bg-surface-muted-dark transition-theme">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-text-secondary dark:text-text-secondary-dark max-w-3xl mx-auto">
              Premium pricing for professional-grade suspended access solutions
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricing.map((plan, index) => (
              ...
              >
                ...
                <Link 
                  to="/contact-us?product=suspended-platforms&period=plan.period"
        ...
        <div className="container-custom text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg lg:text-xl mb-8 max-w-3xl mx-auto text-white/90 leading-relaxed">
              ...
              for your suspended platform needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                to="/contact-us?product=suspended-platforms" 
...
export default SuspendedPlatforms;
