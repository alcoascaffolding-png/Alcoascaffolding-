...
const ServiceCategories = () => {
  const categories = [
    ...
    { title: 'Professional Ladders', link: '/products/ladders', type: 'service' },
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-sm sm:text-base lg:text-lg text-text-secondary dark:text-text-secondary-dark max-w-3xl mx-auto">
            Dedicated UAE location pages — no duplicate query-string URLs
          </p>
        </motion.div>
        ...
        >
          ...
          <Link
            to="/contact-us"
            className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 text-white font-semibold text-sm sm:text-base rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
