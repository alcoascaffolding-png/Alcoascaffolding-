  ...
  const testimonials = [
    {
      ...
      rating: 5,
      quote: "Alcoa delivered cuplock and mobile towers to our Dubai Marina site within four hours. Pricing was transparent in AED and every unit passed our HSE checklist.",
      project: 'High-Rise Façade — Dubai Marina',
    ...
    },
    {
      ...
      company: 'Al Ain Industrial Services',
      ...
      project: 'Plant Maintenance — Al Ain',
