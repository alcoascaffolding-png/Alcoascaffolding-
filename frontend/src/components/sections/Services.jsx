...
import { getServiceIdFromLink } from '../../data/productImageMap';
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        {
          title: 'GI Pipe',
          description: 'Hot-dipped galvanized steel pipe for durable scaffolding and structural applications.',
          features: ['Hot-dipped galvanized', 'Corrosion-resistant', 'Multiple diameters'],
          link: '/services/gi-pipe'
        },
        {
          title: 'MS Pipe',
          description: 'Mild steel pipe for heavy-duty scaffolding and construction support systems.',
          features: ['Heavy-duty mild steel', 'High load capacity', 'Cuplock compatible'],
          link: '/services/ms-pipe'
        },
        {
          title: 'U-Head Jack',
          description: 'Adjustable U-head jacks for supporting beams and distributing loads on uneven surfaces.',
          features: ['Adjustable U-head', 'Beam and slab support', 'Fine height adjustment'],
          link: '/services/u-head-jack'
        },
        {
          ...
          features: ['Swivel base plate', 'Uneven ground leveling', 'Anti-slip design'],
          link: '/services/swivel-base-jack'
        },
        {
          title: 'Fixed Base Plate Jack',
          description: 'Fixed base plate jack with welded stub for stable scaffolding support on firm surfaces.',
          features: ['Fixed base plate', 'Welded stub connection', 'Stable ground support'],
          link: '/services/fixed-base-plate-jack'
        },
        {
          title: 'Beam Ladder',
          description: 'Steel ladder beam for bridging spans and creating wide working platforms.',
          features: ['Long-span bridging', 'Ladder beam profile', 'Platform support'],
          link: '/services/beam-ladder'
        },
        {
          title: 'Steel Planks',
        ...
        },
        {
          ...
          description: 'Standard wooden scaffold boards for safe working platforms on cuplock systems.',
          features: ['Standard board size', 'Natural wood', 'Safe walking surface'],
          link: '/services/standard-wood-plank'
        },
        {
          title: 'Lattice Beam',
            ...
            >
              ...
              >
                {categoryItem.services.map((service, serviceIndex) => {
                  const serviceId = getServiceIdFromLink(service.link);
                  ...
                  >
                    <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden h-full flex flex-col hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700">
                      {/* Service Image: product images folder only, else icon */}
                      <div className="w-full h-48 sm:h-56 overflow-hidden bg-gradient-to-br from-blue-50 to-gray-50 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
                        <ProductImageDisplay
                          productId={serviceId}
                          alt={service.title}
                          fallbackEmoji={categoryItem.icon}
