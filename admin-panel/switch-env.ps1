# PowerShell script to switch between production and development environments
...
Write-Host ""
Write-Host "Switching to $TargetEnv environment..." -ForegroundColor Cyan
Write-Host ""
...
if ($TargetEnv -eq "production") {
    Write-Host "  1. Using Production Backend on Render.com" -ForegroundColor Yellow
    Write-Host "  2. Make sure backend is deployed" -ForegroundColor Yellow
    Write-Host "  3. Run: npm run dev" -ForegroundColor White
} else {
    Write-Host "  1. Using Local Backend on localhost:5000" -ForegroundColor Yellow
