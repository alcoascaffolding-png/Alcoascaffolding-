    ...
    <tr className={`hover:bg-gray-50 ${message.status === 'new' ? 'bg-blue-50' : ''}`}>
      ...
      <td className="px-6 py-4 whitespace-nowrap text-right">
        <div className="flex items-center justify-end gap-2">
          {/* WhatsApp Button */}
          <a
            href={`https://wa.me/${message.phone.replace(/\D/g, '')}?text=${encodeURIComponent(`Hello ${message.name}, Thank you for contacting Alcoa Scaffolding. We received your message and would like to discuss further.`)}`}
            target="_blank"
