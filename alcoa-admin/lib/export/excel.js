...
export const EXPORT_COLUMNS = {
  ...
  vendors: [
    { header: "Code", key: "vendorCode", width: 16 },
    { header: "Company Name", key: "companyName", width: 30 },
    { header: "Contact Person", key: "contactPerson", width: 22 },
    { header: "Email", key: "email", width: 30 },
    { header: "Phone", key: "phone", width: 18 },
    { header: "VAT / TRN", key: "vatNumber", width: 20 },
    { header: "Category", key: "category", width: 16 },
    { header: "Payment Terms", key: "paymentTerms", width: 14 },
    { header: "Credit Limit (AED)", key: "creditLimit", width: 18, numFmt: "#,##0.00" },
    { header: "Status", key: "status", width: 12 },
    { header: "Created", key: "createdAt", width: 18 },
  ],
  "purchase-orders": [
  ...
  receipts: [
    { header: "Receipt #", key: "receiptNumber", width: 16 },
    { header: "Customer", key: "customerName", width: 30 },
    { header: "Receipt Date", key: "receiptDate", width: 14 },
    { header: "Method", key: "paymentMethod", width: 16 },
    { header: "Reference", key: "reference", width: 20 },
    { header: "Amount (AED)", key: "amount", width: 18, numFmt: "#,##0.00" },
  ],
  payments: [
    { header: "Payment #", key: "paymentNumber", width: 16 },
    { header: "Vendor", key: "vendorName", width: 30 },
