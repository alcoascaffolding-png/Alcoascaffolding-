...
/** Brand navy — always light login chrome (ignore app dark mode). */
const BRAND_NAVY = "#1d3a6c";
    ...
    <Providers forcedTheme="light">
      <SessionProvider>
        ...
        <div className="login-surface min-h-screen grid lg:grid-cols-2">
          {/* Left — brand */}
          <div
            className="relative hidden lg:flex flex-col items-center justify-center px-12 py-16 overflow-hidden"
